...
class LoanModel {
  ...
  static LoanEntity fromJoinedJson(Map<String, dynamic> json) {
    return LoanEntity(
      ...
      borrowedAt: DateTime.parse(json['borrowedAt'] as String).toLocal(),
